...
export default function CourseCard({ course }) {
  ...
  return (
    <div className="bg-white dark:bg-darkBg rounded-2xl shadow-lg overflow-hidden border border-gray-200 
      ...
      <div className="p-4">
        <h3 className="font-bold text-lightText dark:text-darkText line-clamp-2 group-hover:text-primary 
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2">
            {isDiscounted ? (
              <>
                <span className="text-lg font-bold text-primary">{course.price} ريال</span>
          ...
          <button className="bg-primary hover:bg-primaryHover text-white px-4 py-2 rounded-xl 

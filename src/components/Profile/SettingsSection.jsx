...
export default function SettingsSection({ onChangePassword }) {
  return (
    <section className="bg-white   rounded-2xl shadow-md dark:shadow-navbarDark p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">

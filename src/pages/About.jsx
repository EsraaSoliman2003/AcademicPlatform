    ...
    >
      <div className="max-w-6xl w-full">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="text-center group">
                <div className="bg-gradient-to-br from-lightPrimary to-white rounded-2xl p-4 border border-gray-100 shadow-md group-hover:shadow-lg transition-all duration-300">
                  <div className="text-2xl font-bold text-primary mb-1 transition-transform">
                    +50
                  </div>
                  <div className="text-sm text-grayText">مشروع</div>
                </div>
              </div>
              ...
              <div className="text-center group">
                <div className="bg-gradient-to-br from-lightPrimary to-white rounded-2xl p-4 border border-gray-100 shadow-md group-hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="text-sm text-grayText">سنوات</div>
                </div>
              </div>
              ...
              <div className="text-center group">
                <div className="bg-gradient-to-br from-lightPrimary to-white rounded-2xl p-4 border border-gray-100 shadow-md group-hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="text-sm text-grayText">رضا عملاء</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2">
            <div className="bg-gradient-to-r from-primary/5 to-accentColor/5 rounded-2xl p-8 border border-primary/10 h-full">
              <div className="text-right">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-primary/10 rounded-full mb-4 mr-0 ml-auto">
                  <span className="text-lg">🎯</span>
                </div>
                <h2 className="text-2xl font-semibold text-lightText mb-4 text-right">
                  رؤيتنا
                </h2>
                <p className="text-grayText leading-relaxed text-right text-lg">
            ...
            <div className="mt-6 bg-white rounded-2xl p-6 border border-gray-100">
              <div className="text-right">
                <h3 className="text-lg font-semibold text-lightText mb-3">
                  لماذا نحن؟
                </h3>
                <ul className="text-grayText space-y-2 text-right">

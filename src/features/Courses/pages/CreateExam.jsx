...
export default function CreateExam({ onSave }) {
  ...
  const handleSave = () => {
    onSave({...formData, examId: Date.now()});
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-6">
        ...
        <button onClick={handleSave} className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700">حفظ الامتحان</button>
      </div>
    </div>
  );
}

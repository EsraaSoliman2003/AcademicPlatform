...
export default function Navbar() {
  ...
  return (
    <header
      className={`w-full fixed top-0 left-0 z-50 h-[72px] bg-transparent text-darkText backdrop-blur-sm shadow-[0_2px_6px_rgba(0,0,0,0.08)] transition-all duration-navbar font-arabic`}
    >
